...
questionlist = [
    (
        r"\rvert-\rangle=\frac{1}{\sqrt{2}}(\rvert0\rangle-\rvert1\rangle)",
        True,
        r"\text{Yes, because }\left|\frac{1}{\sqrt{2}}\right|^2 + \left|\frac{1}{\sqrt{2}}\right|^2 = 1",
    ),
    (
        r"\frac{1}{\sqrt{2}}\rvert0\rangle-\frac{1+i}{2}\rvert1\rangle",
        True,
        r"\text{Yes, because }\left|\frac{1}{\sqrt{2}}\right|^2 + \left|\frac{-1-i}{2}\right|^2=\frac{1}{2} + (\ \frac{1}{4} + \frac{1}{4} )= 1",
    ),
    (
        r"\frac{1+i}{3}\rvert0\rangle-\frac{1-i}{2}\rvert1\rangle",
        False,
        r"\text{No, because }\left|\frac{1+i}{3}\right|^2+\left|\frac{-i+1}{2}\right|^2 = (\ \frac{1}{3})^2+(\ \frac{1}{3})^2+(\ \frac{-1}{2})^2+(\ \frac{1}{2})^2 \ne 1",
        1,
    ),
    (
        r"\frac{i}{10}\rvert0\rangle+\frac{99}{10}\rvert1\rangle",
        False,
        r"\text{No, because }\left|\frac{i}{10}\right|^2+\left|\frac{99}{10}\right|^2 \ne 1",
        2,
    ),
    (
        r"\frac{\sqrt{3}}{2}\rvert0\rangle+\frac{1}{3}\rvert1\rangle",
        False,
        r"\text{No, because }\left|\frac{\sqrt{3}}{2}\right|^2+\left|\frac{1}{3}\right|^2 = \frac{3}{4} + \frac{1}{9} \ne 1",
        3,
    ),
    (
        r"\frac{i}{\sqrt{2}}(\rvert0\rangle+\rvert1\rangle)",
        True,
        r"\text{Yes, because }\left|\frac{i}{\sqrt{2}}\right|^2 + \left|\frac{i}{\sqrt{2}}\right|^2 = \frac{1}{2} + \frac{1}{2} = 1",
    ),
    (
        r"\frac{1}{\sqrt{2}}(\rvert0\rangle+e^{\frac{i\pi}{2}}\rvert1\rangle)",
        True,
        r"\text{Yes, because }\left|\frac{1}{\sqrt{2}}\right|^2 + \left|\frac{e^{\frac{i\pi}{2}}}{\sqrt{2}}\right|^2 = \frac{1}{2} + \left|\frac{\cos(\ \frac{\pi}{2})+i\sin(\ \frac{\pi}{2})}{\sqrt{2}}\right|^2=\frac{1}{2}+\frac{\cos^2\frac{\pi}{2}}{2}+\frac{\sin^2\frac{\pi}{2}}{2}=1",
    ),
    (
        r"\frac{1}{2}\rvert0\rangle-\frac{i}{2}\rvert1\rangle",
        False,
        r"\text{No, because }\left|\frac{1}{2}\right|^2+\left|\frac{-i}{2}\right|^2 = \frac{1}{4} + \frac{1}{4} \ne 1",
        4,
    ),
    (
        r"\frac{\sqrt{3}}{2}\rvert0\rangle+\frac{1}{4}\rvert1\rangle",
        False,
        r"\text{No, because }\left|\frac{\sqrt{3}}{2}\right|^2+\left|\frac{1}{4}\right|^2 = \frac{3}{4} + \frac{1}{16} \ne 1",
        5,
    ),
    (
        r"e^{i\pi}\rvert-\rangle",
        True,
        r"\text{Yes, because }\left|e^{i\pi}\right|^2=1",
    ),
]
...
def refreshq():
    ...
    solutionquestion.clear_output()
    with solutionquestion:
        display(
            Math(
...
q1 = prepareQuestion(
    "Make $\\frac{1+i}{3}\\rvert0\\rangle-\\frac{1-i}{2}\\rvert1\\rangle$  a valid qubit",
    ["hint 1", "hint 2", "hint 3", "hint 4", "hint 5"],
    "length = $\sqrt{\\frac{13}{18}}$  <br>"
...
q2 = prepareQuestion(
    "Make $\\frac{i}{10}\\rvert0\\rangle+\\frac{99}{10}\\rvert1\\rangle$  a valid qubit",
    ["hint 1"],
    "length = $\sqrt{\\frac{9802}{100}}$  <br>"
...
q3 = prepareQuestion(
    "Make $\\frac{\sqrt{3}}{2}\\rvert0\\rangle+\\frac{1}{3}\\rvert1\\rangle$  a valid qubit",
    ["hint 1", "hint 2", "hint 3", "hint 4", "hint 5"],
    "length = $\sqrt{\\frac{9802}{100}}$  <br>"
    + '<font size="-1">Therefore, $\\rvert\psi\\rangle = \sqrt{\\frac{100}{9802}}\\times\\frac{i}{10} \\rvert0\\rangle+ \sqrt{\\frac{100}{9802}}\\times\\frac{99}{10} \\rvert1\\rangle$ is a valid qubit.',
)
q4 = prepareQuestion(
    "Make $\\frac{1}{2}\\rvert0\\rangle-\\frac{i}{2}\\rvert1\\rangle$  a valid qubit",
    ["hint 1"],
    "length = $\sqrt{\\frac{1}{2}}$  <br>"
...
q5 = prepareQuestion(
    "Make $\\frac{\sqrt{3}}{2}\\rvert0\\rangle+\\frac{1}{4}\\rvert1\\rangle$  a valid qubit",
    ["hint 1"],
    "length = $\sqrt{\\frac{13}{16}}$  <br>"
...
Accordion code
"""
solution_question_output = Output()
with solution_question_output:
    display(Math(r"\text{Is this a valid qubit?}"))
solutionquestion = solution_question_output
workedout = VBox(
    [
        solutionquestion,
        Label(),
...
def createQuiz10_1():
    hideSolution()
    refreshq()
    display(widgets.HTMLMath(value='<b><font size="+2">Exercise 1'))
    display(
        widgets.HTMLMath(
            value='<font size="+1">Which of the following are examples of valid qubits?'
        )
    )
    display(SAQuiz10_3)
...
"""    display(widgets.HTMLMath(value='<b><font size="+2">Exercise 2'))
    display(
        widgets.HTMLMath(
            value='<font size="+1">For each non-valid qubit, re-normalize the coefficients to convert them into valid qubits.'
        )
    )"""
