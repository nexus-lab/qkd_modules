...
questionlist = [
    (
        r"\frac{1}{\sqrt{2}}(-\rvert0\rangle+i\rvert1\rangle)",
        True,
        r"\text{Yes, because }\alpha=\frac{-1}{\sqrt{2}} \beta=\frac{i}{\sqrt{2}}",
        1,
    ),
    (
        r"\frac{1}{2}\rvert+\rangle+\frac{\sqrt{3}}{2}\rvert-\rangle",
        True,
        r"\text{Yes, because }\Rightarrow \alpha = \frac{1+\sqrt{3}}{2\sqrt{2}} , \beta = \frac{1-\sqrt{3}}{2\sqrt{2}}",
        2,
    ),
    (
        r"\rvert-\rangle",
        True,
        r"\text{Yes, because }\alpha = \frac{1}{\sqrt{2}}, \beta = \frac{-1}{\sqrt{2}}",
        3,
    ),
    (
        r"\frac{1}{\sqrt{2}}\rvert0\rangle-\frac{e^{i\pi}}{\sqrt{2}}\rvert1\rangle",
        True,
        r"\text{Yes, because }\alpha = \frac{1}{\sqrt{2}} , \beta = \frac{-e^{i\pi}}{\sqrt{2}}",
        4,
    ),
    (r"-\rvert1\rangle", False, r"\text{No, because }\alpha=0, \beta=-1"),
    (
        r"\frac{1+i}{2}\rvert+\rangle+\frac{1-i}{2}\rvert-\rangle",
        True,
        r"\text{Yes, because }\alpha = \frac{1}{\sqrt{2}}, \beta = \frac{i}{\sqrt{2}}",
        5,
    ),
    (
        r"\frac{1+i}{2}\rvert1\rangle-\frac{1-i}{2}\rvert0\rangle",
        True,
        r"\text{Yes, because }\alpha = \frac{-1+i}{2}, \beta = \frac{1+i}{2}",
        6,
    ),
]
...
probstatment = widgets.HTML(
    value='<font size="+1">Is the following a superposition with respect to the standard basis?'
)
...
with question_output:
    display(Math(r"\text{Question not generated}"))

solution_output = Output()
with solution_output:
    display(Math(r"\text{Question not generated}"))

curq = question_output
qsolution = solution_output


def makeSolution():
    qsolution.clear_output()
    with qsolution:
        display(Math(questionlist[curquestion][2]))
...
def refreshq():
    curq.clear_output()
    with curq:
        display(Math(questionlist[curquestion][0]))

    qsolution.clear_output()
    with qsolution:
        display(
            Math(
                r"\text{Is }" + questionlist[curquestion][0] + r"\text{ a valid qubit?}"
            )
        )
    ...
    [
        ...
        VBox(
            [
                HBox(
                    [
                        VBox([Label(), curq], layout=Layout(width="400px")),
                        Label(),
                        VBox([btn_yes, Label(), btn_no]),
                    ]
                )
            ],
        ...
        Label(),
        VBox(
            [HBox([btn_solution, Label(), btn_2_check, Label(), btn_2_restart])],
            layout=Layout(align_items="center"),
        ),
    ]
)
...
q1 = prepareQuestion(
    "Find a basis where is $\\rvert\psi\\rangle = \\frac{-\\rvert0\\rangle+i\\rvert1\\rangle}{\sqrt{2}}$  not in a superposition with respect to standard basis.",
    ["hint 1", "hint 2", "hint 3", "hint 4", "hint 5"],
    '<font size="-1">$\\rvert\psi\\rangle = \\frac{-\\rvert0\\rangle+i\\rvert1\\rangle}{\sqrt{2}}$ is not in superposition with respect to basis $\left\{\\begin{bmatrix}\\frac{-1}{\sqrt{2}}\\\\\\frac{i}{\sqrt{2}}\end{bmatrix},\\begin{bmatrix}\\\\\\frac{-i}{\sqrt{2}}\\\\\\frac{1}{\sqrt{2}}\end{bmatrix}\\right\}$',
)
q2 = prepareQuestion(
    "Find a basis where is $\\rvert\psi\\rangle = \\frac{1}{2}\\rvert+\\rangle + \\frac{\sqrt{3}}{2}\\rvert-\\rangle$ not in a superposition with respect to standard basis.",
    ["hint 1"],
    '<font size="-1">$\\rvert\psi\\rangle = \\frac{1}{2}\\rvert+\\rangle + \\frac{\sqrt{3}}{2}\\rvert-\\rangle$ is not in superposition w.r.t'
...
q3 = prepareQuestion(
    "Find a basis where is  $\\rvert-\\rangle = \\frac{\\rvert0\\rangle - \\rvert1\\rangle}{\sqrt{2}}$ not in a superposition with respect to standard basis.",
    ["hint 1", "hint 2", "hint 3", "hint 4", "hint 5"],
    '<font size="-1"> $\\rvert-\\rangle = \\frac{\\rvert0\\rangle - \\rvert1\\rangle}{\sqrt{2}}$ is not in superposition w.r.t '
    + "$B = \left\{\\begin{bmatrix}\\frac{1}{\sqrt{2}}\\\\\\frac{1}{\sqrt{2}}\end{bmatrix},\\begin{bmatrix}\\frac{1}{\sqrt{2}}\\\\\\frac{-1}{\sqrt{2}}\end{bmatrix}\\right\}$",
)
q4 = prepareQuestion(
    "Find a basis where is $\\rvert\psi\\rangle = \\frac{1}{\sqrt{2}}\\rvert0\\rangle-\\frac{e^{i\pi}}{\sqrt{2}}\\rvert1\\rangle$ not in a superposition with respect to standard basis.",
    ["hint 1"],
    '<font size="-1">$\\rvert\psi\\rangle = \\frac{1}{\sqrt{2}}\\rvert0\\rangle-\\frac{e^{i\pi}}{\sqrt{2}}\\rvert1\\rangle$'
...
q5 = prepareQuestion(
    "Find a basis where is $\\rvert\psi\\rangle = \\frac{1+i}{2}\\rvert+\\rangle+\\frac{1-i}{2}\\rvert-\\rangle=$ not in a superposition with respect to standard basis.",
    ["hint 1"],
    '<font size="-1"> $\\frac{1+i}{2}\\rvert+\\rangle+\\frac{1-i}{2}\\rvert-\\rangle$ is not in superposition w.r.t  $B = \left\{\\begin{bmatrix}\\frac{1}{\sqrt{2}}\\\\\\frac{i}{\sqrt{2}}\end{bmatrix},\\begin{bmatrix}\\frac{-i}{\sqrt{2}}\\\\\\frac{-1}{\sqrt{2}}\end{bmatrix}\\right\}$',
)

q6 = prepareQuestion(
    "Find a basis where is $\\rvert\psi\\rangle = \\frac{1+i}{2}\\rvert1\\rangle-\\frac{1-i}{2}\\rvert0\\rangle$ not in a superposition with respect to standard basis.",
    ["hint 1"],
    '<font size="-1"> $\\rvert\psi\\rangle = \\frac{1+i}{2}\\rvert1\\rangle-\\frac{1-i}{2}\\rvert0\\rangle$ is not in superposition w.r.t '
...
Accordion code
"""
solutionquestion = widgets.HTMLMath(
    value='<font size="+1">Is the following a superposition with respect to the standard basis?'
)
workedout = VBox(
    [
        ...
        Label(),
        VBox(
            [HBox([btn_back], layout=Layout(width="100%", align_items="center"))],
...
"""    display(widgets.HTMLMath(value='<b><font size="+2">Exercise 2'))
    display(
        widgets.HTMLMath(
            value='<font size="+1">For the qubits that are in superposition with respect to standard basis, give a basis with respect to which they are not in superposition.'
        )
    )
    display(Label())"""
